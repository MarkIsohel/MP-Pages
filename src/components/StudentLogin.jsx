...
function StudentLogin() {
    ...
    return (
        ...
        <>
            ...
            <div className='flex max-w-[800px] mx-auto border-l-12 border-b-12 border-yellow-700 border-r-12 border-r-yellow-300 bg-[#b87928] shadow-[#b87928] shadow-2xl  justify-center rounded-r-3xl rounded-l-3xl  '>
                <div className=' w-1/4'>
                </div>
                <div className='bg-white w-3/4 rounded-l-3xl rounded-r-3xl hover:shadow-black hover:shadow-xl pr-2'>
                    <div className=' text-center text-5xl font-bold'>
                        <div className=' mt-12'><p>Student</p></div>
                    ...
                    <form onSubmit={handleSubmit} className='mt-6'>
                        ...
                        <div className='text-left flex px-12 mt-8'>
                            ...
                            <input className={` bg-[#e0e0e0] rounded-full w-full text-xl text-gray-700 px-3  py-2 ${errors.password && touched.password ? " border-red-500 focus:border-red-500 border-2 border-solid" : ""} `} type="password" name='password' placeholder='Student LRN' autoComplete='off' required
